...
Edit the `c:\Windows\System32\Drivers\etc\hosts` file so that Windows knows that when the browser reaches out
to `docker.streetlightdata.net` it should look at the localhost instead.

```powershell
PS C:\Users\bruno.langeramos> cat c:\Windows\System32\Drivers\etc\hosts
...
192.168.1.54 host.docker.internal
192.168.1.54 gateway.docker.internal
# To allow the same kube context to work on the host and the container:
127.0.0.1 kubernetes.docker.internal
# End of section

127.0.0.1 docker.streetlightdata.net
0.0.0.0 EgnyteDrive.local
0.0.0.0 EgnyteDrive
```

Finally, open your browser and navigate to http://docker.streetlightdata.net:8000.
